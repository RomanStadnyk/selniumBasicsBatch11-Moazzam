...
public class Class1 {
    ...
    public static void main(String[] args) {
        ...
        WebElement notifictionMessage =  driver.findElement(By.cssSelector("td p:nth-child(2) font"));
        //WebElement notifictionMessage1 =  driver.findElement(By.xpath("//b[contains(text(),'Note: Your user name is']"));

        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

        if(notifictionMessage.isDisplayed()){
